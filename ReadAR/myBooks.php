...
<?php 
                      ...
                      $daArray = array();
                      $sql2 = "SELECT bookId, bookName, author, publishYear FROM books ";
...
<?php 
                      ...
                      $daArray = array();
                      $sql2 = "SELECT bookId, bookName, author, publishYear FROM books WHERE ownerId = ".$row["id"]."";
                      $result2 = mysqli_query($db,$sql2);                          
